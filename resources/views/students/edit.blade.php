                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <select
                            ...
                            <option value="male" {{ old('gender',$student->gender) == 'male' ? 'selected' : '' }} class="bg-slate-900 text-slate-100">Male</option>
                            <option value="female" {{ old('gender',$student->gender) == 'female' ? 'selected' : '' }} class="bg-slate-900 text-slate-100">Female</option>
                        </select>
